...
public class JwtUtility {
    ...
    /// Creating Token
    /*
       generateToken Method -> has Map claims - key : username, value : ___
                            -> calls the createToken method

       createToken  ->  get the username from claims, add issueAt date, expiry date
                        then generate token with secret key and algo HS256
